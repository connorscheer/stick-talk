        ...
        <div style={styles.chartCard}>
          ...
          <ResponsiveContainer width="100%" height={110}>
            <LineChart data={trendData} margin={{ top: 6, right: 10, bottom: 0, left: 10 }}>
              ...
              <Tooltip
                contentStyle={{ background: "#3A3936", border: "1px solid #74C69D", borderRadius: 8, fontSize: 12 }}
...
const styles = {
  ...
  inboxCard: { background: "#232220", border: "1px solid #74C69D", borderRadius: 14, padding: 13, marginBottom: 10 },
  inboxNote: { fontSize: 12.5, color: "#A3A199", marginTop: 5, fontStyle: "italic" },
  declineBtn: { flex: 1, background: "transparent", border: "1px solid #74C69D", color: "#A3A199", borderRadius: 8, fontSize: 12.5, fontWeight: 700, padding: "8px 0" },
  ...
  gpsPreview: { background: "#232220", border: "1px solid #74C69D", borderRadius: 14, marginTop: 22, overflow: "hidden" },
  ...
  card: { background: "#232220", border: "1px solid #74C69D", borderRadius: 20, padding: 18, marginBottom: 18, boxShadow: "0 8px 28px rgba(0,0,0,0.18)" },
  rowCard: { background: "#232220", border: "1px solid #74C69D", borderRadius: 12, padding: 12, marginBottom: 8, display: "flex", justifyContent: "space-between", alignItems: "center" },
  ...
  avatarLg: { width: 64, height: 64, borderRadius: "50%", background: "#4A4844", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 20, fontWeight: 700, margin: "0 auto 10px" },
  ...
  chartCard: { background: "#232220", border: "1px solid #74C69D", borderRadius: 14, padding: "12px 8px", marginBottom: 14 },
  ...
  filterCard: { background: "#232220", border: "1px solid #74C69D", borderRadius: 14, padding: 14, marginBottom: 14 },
  ...
  matchCard: { background: "#232220", border: "1px solid #74C69D", borderRadius: 14, padding: 12, marginBottom: 10, display: "flex", gap: 10, alignItems: "flex-start" },
  availText: { fontSize: 11.5, color: "#74C69D", marginTop: 3 },
  hcpChip: { fontFamily: "'Baloo 2', sans-serif", fontSize: 11, background: "#171513", border: "1px solid #74C69D", borderRadius: 6, padding: "2px 7px" },
  ...
  avatarRing: { width: 76, height: 76, borderRadius: "50%", background: "#232220", border: "3px solid #74C69D", boxShadow: "0 2px 10px rgba(0,0,0,0.25)", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto", padding: 3 },
  ...
  avatarRingSm: { width: 62, height: 62, borderRadius: "50%", background: "#232220", border: "3px solid #74C69D", boxShadow: "0 2px 10px rgba(0,0,0,0.25)", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto", padding: 3 },
  ...
  profileViewStamp: { background: "#171513", border: "1px solid #74C69D", borderRadius: 12, padding: "12px 10px", display: "flex", flexDirection: "column", alignItems: "center", marginBottom: 14 },
  ...
  ghinCard: { background: "#232220", border: "1px solid #74C69D", borderRadius: 14, padding: 13, marginBottom: 14 },
  ...
  connectBtn: { background: "transparent", border: "1px solid #74C69D", color: "#74C69D", borderRadius: 7, fontSize: 12, fontWeight: 700, padding: "6px 12px" },
  connectedChip: { background: "rgba(116,198,157,0.15)", color: "#74C69D", fontSize: 11, fontWeight: 700, borderRadius: 7, padding: "5px 10px", border: "1px solid #74C69D" },
  ghinModalCopy: { fontSize: 13, color: "#A3A199", lineHeight: 1.5, marginBottom: 14 },
  settingsRow: { width: "100%", background: "#232220", border: "1px solid #74C69D", borderRadius: 10, padding: "13px 14px", display: "flex", justifyContent: "space-between", alignItems: "center", color: "#FFFFFF", fontSize: 13.5, marginBottom: 8 },
  modalOverlay: { position: "fixed", inset: 0, background: "rgba(0,0,0,0.55)", display: "flex", alignItems: "flex-end", zIndex: 10 },
  modal: { background: "#232220", width: "100%", maxWidth: 420, margin: "0 auto", borderRadius: "18px 18px 0 0", padding: 20, border: "1px solid #74C69D", borderBottom: "none" },
  ...
  spotsBtn: { width: 32, height: 32, borderRadius: "50%", background: "#171513", border: "1px solid #74C69D", color: "#74C69D", fontSize: 18, fontWeight: 700, display: "flex", alignItems: "center", justifyContent: "center" },
  spotsValue: { fontFamily: "'Baloo 2', sans-serif", fontWeight: 800, fontSize: 22, color: "#FFFFFF", minWidth: 20, textAlign: "center" },
  input: { width: "100%", background: "#171513", border: "1px solid #74C69D", borderRadius: 8, padding: "9px 10px", color: "#FFFFFF", fontSize: 14, marginTop: 5 },
  suggestList: {
    position: "absolute",
    top: "calc(100% + 4px)",
    left: 0,
  ...
  toggleChip: { flex: 1, background: "#171513", border: "1px solid #74C69D", borderRadius: 8, padding: "9px 6px", fontSize: 12.5, color: "#A3A199", fontWeight: 600 },
  toggleChipActive: { background: "#74C69D", color: "#000000", border: "1px solid #74C69D" },
  ...
  teeChip: { background: "#171513", border: "1px solid #74C69D", borderRadius: 8, padding: "7px 12px", fontSize: 12.5, color: "#A3A199", fontWeight: 600 },
  teeChipActive: { background: "#74C69D", color: "#000000", border: "1px solid #74C69D" },
  backBtn: { flex: "0 0 84px", background: "transparent", border: "1px solid #74C69D", borderRadius: 10, color: "#A3A199", fontWeight: 700, fontSize: 13.5 },
  ...
  holeInput: { width: 50, background: "#171513", border: "1px solid #74C69D", borderRadius: 7, padding: "6px 4px", color: "#FFFFFF", fontSize: 13, textAlign: "center" },
  ...
  holeGridInput: { width: "100%", background: "#232220", border: "1px solid #74C69D", borderRadius: 6, padding: "5px 0", color: "#FFFFFF", fontSize: 14, fontWeight: 700, textAlign: "center" },

  // ---- Composer / feed extras ----
  composerTrigger: { width: "100%", background: "#232220", border: "1px solid #74C69D", borderRadius: 14, padding: "12px 14px", display: "flex", alignItems: "center", gap: 10, marginBottom: 18, textAlign: "left", boxShadow: "0 4px 16px rgba(0,0,0,0.1)" },
  ...
  matchConfirmedTile: { display: "flex", alignItems: "center", gap: 10, background: "#232220", border: "1px solid #74C69D", borderRadius: 14, padding: "10px 14px", marginBottom: 14 },
  ...
  composerTextarea: { width: "100%", background: "#171513", border: "1px solid #74C69D", borderRadius: 10, padding: 12, color: "#FFFFFF", fontSize: 14, resize: "none", marginBottom: 12, fontFamily: "inherit" },
  ...
  shareRow: { display: "flex", justifyContent: "space-between", alignItems: "center", background: "#171513", border: "1px solid #74C69D", borderRadius: 10, padding: "11px 13px", marginBottom: 14 },
